...
public class CDWeaponCapabilityPresets {
    ...
    public static final Function<Item, CapabilityItem.Builder> YAMATO = item ->
            WeaponCapability.builder()
                    ...
                    .newStyleCombo(Styles.TWO_HAND, CorruptAnimations.EX_YAMATO_AUTO1, CorruptAnimations.EX_YAMATO_AUTO2,CorruptAnimations.EX_YAMATO_AUTO3,CorruptAnimations.EX_YAMATO_AUTO4, CorruptAnimations.YAMATO_STRIKE1, CorruptAnimations.YAMATO_POWER3_REPEAT, CorruptAnimations.YAMATO_TWIN_SLASH,CorruptAnimations.YAMATO_TURN_SLASH)
